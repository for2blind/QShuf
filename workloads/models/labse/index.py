...
def load_model_and_update_status(loaded_app):
    ...
    with torch.inference_mode():
        ...
        x = ['This framework generates embeddings for each input sentence, Sentences are passed as a list of string.']
        model= torch.load(f'/sharing/model/labse.pt',map_location=infer_device)
